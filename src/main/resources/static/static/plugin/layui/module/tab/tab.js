layui.define(['jquery', 'element'], function(exports) {
	...
	pearTab.prototype.addTab = function(opt) {
		...
		if (opt.close) {
			title += '<span class="pear-tab-active"></span><span class="able-close title">' + opt.title +
				'</span><i class="layui-icon layui-unselect layui-tab-close layui-icon-close"></i>';
		} else {
	...
	function createTab(option) {
		...
		$.each(option.data, function(i, item) {
			...
			TitleItem += '<i class="layui-icon layui-unselect layui-tab-close layui-icon-close"></i></li>';
			title += TitleItem;
			if (option.index == index) {
