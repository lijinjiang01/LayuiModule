        ...
        $.each(option.data, function (i, item) {
            ...
            if (item.type == 0) {
                ...
                content += '<a class="' + className + '" menu-type="' + item.type + '" menu-open-type="' + item.openType + '"  menu-url="' + item.href + '" menu-id="' +
                    item.id +
                    '" menu-title="' + item.title + '"  href="' + href + '"  ' + target + '><i class="layui-icon ' + item.icon +
            ...
            $.each(item.children, function (i, note) {
                ...
                if (note.type == 0) {
                    ...
                    content += '<a  href="' + href + '" ' + target + ' menu-type="' + note.type + '" menu-id="' + note.id +
                        '" ><i class="layui-icon ' + note.icon + '"></i><span>' + note.title +
                        '</span></a>';
                } else if (note.type == 1) {
                    // 创 建 菜 单 结 构
                    content += '<a ' + target + ' class="' + className + '" menu-open-type="' + note.openType + '" menu-type="' + note.type + '" menu-url="' + note.href +
                        '" menu-id="' + note.id +
                        '" menu-title="' + note.title + '" href="' + href + '"><i class="layui-icon ' + note.icon +
        ...
        if (obj.children != null && obj.children.length > 0) {
            ...
            $.each(obj.children, function (i, note) {
                ...
                if (note.type == 0) {
                    ...
                    // 创 建 菜 单 结 构
                    content += '<a ' + target + ' class="' + className + '" menu-open-type="' + note.openType + '" menu-type="' + note.type + '" menu-url="' + note.href +
                        '" menu-id="' + note.id + '" menu-title="' + note.title + '" menu-icon="layui-icon ' + note.icon + '" href="' + href +
                        '" ><i class="layui-icon ' + note.icon + '"></i><span>' + note.title + '</span></a>';
                }
                // 加 载 子 项 目 录
                content += loadchild(note);
