...
layui.define(['laypage', 'form'], function (exports) {
    ...
    IconPicker.prototype.render = function(options){
        ...
        var common = {
            ...
            getData: {
                fontClass: function () {
					let iconData = common.loadIconData();
			...
			loadIconData: function() {
				let icons=[];
				let iconfontPath = "layui/font/iconfont.svg";
				let data;
				$.ajax({
					url: iconfontPath,
					type: 'get',
				...
				console.log(data);
				let svg  = data.getElementsByTagName("svg")[0].getElementsByTagName("defs")[0].getElementsByTagName("font")[0].getElementsByTagName("glyph");
				//console.log(svg);
				console.log("data.length = "+svg.length);
				for(let i = 0;i<svg.length;i++){
					let iconName = svg[i].getAttribute("glyph-name");
					console.log(iconName);
					icons.push("layui-icon-"+iconName);
				}
				return icons;
			}
        };
